...
public abstract class BattleAnimation {
    ...
    public void setSecondaryWidth(float newValue) {
        secondaryWidth = newValue;
    }

    public void setSecondaryHeight(float newValue) {
        secondaryHeight = newValue;
    }

    public void setPrimaryMaskAmount(float newValue) {
        primaryMaskAmount = newValue;
    }

    public void setSecondaryMaskAmount(float newValue) {
        secondaryMaskAmount = newValue;
    }

    protected void setPrimaryMask(Texture whiteMask) {
        primaryMask = whiteMask;
    }
}