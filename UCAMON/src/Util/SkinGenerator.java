...
public class SkinGenerator {
    ...
    public static Skin generateSkin(AssetManager assetManager) {
        ...
        if (!assetManager.isLoaded("resources/graphics_packed/ui/uipack.atlas")) {
            throw new GdxRuntimeException("uipack.atlas was not loaded");
        }

        TextureAtlas uiAtlas = assetManager.get("resources/graphics_packed/ui/uipack.atlas");
        ...
        FreeTypeFontGenerator generator = new FreeTypeFontGenerator(Gdx.files.internal("resources/font/pkmnrsi.ttf"));
        ...
        BitmapFont smallFont = assetManager.get("resources/font/small_letters_font.fnt", BitmapFont.class);
